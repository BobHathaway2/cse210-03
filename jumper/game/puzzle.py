...
class Puzzle:
    ...
    Attributes:
        _list_of_words (list): a list of words to choose from
        _secret_word (string): The word chosen for this round of the game
    ...
    def __init__(self):
        ...
        """
        self._list_of_secret_words = ["sagebrush", "elephant", "pilot", "firewood", "elongate", "novel", "declaration"]
        self._secret_word = ""
        self._puzzle = ""
        self._select_secret_word()
        self._build_puzzle()

    def _select_secret_word(self):
        self._secret_word = self._list_of_secret_words[random.randint(0,6)]
    ...
    def update_puzzle(self, jumper_guess):
        ...
        valid_guess = False
        while found:
            location = self._secret_word.find(jumper_guess,i)
            if location != -1:
